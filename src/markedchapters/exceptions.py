class MarkedChaptersException(Exception):
    pass


# errors
class MismatchedListType(MarkedChaptersException):
    pass


class InvalidIndentation(MarkedChaptersException):
    pass


class TabsNotAllowed(MarkedChaptersException):
    pass


class InvalidLevel(MarkedChaptersException):
    pass


class InvalidLine(MarkedChaptersException):
    pass
